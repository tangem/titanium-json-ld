...
public final class DocumentParser {
     ...
     * 
     * @throws com.tangem.jsonld.api.JsonLdError in a case of parsing error
     */
    public static Document parse(final MediaType contentType, final InputStream inputStream)  throws com.tangem.jsonld.api.JsonLdError {
     ...
     * @throws com.tangem.jsonld.api.JsonLdError in a case of parsing error
     */
    public static Document parse(final MediaType contentType, final Reader reader)  throws com.tangem.jsonld.api.JsonLdError {
    ...
    private static final Document fireUnsupportedMediaType(MediaType contentType) throws com.tangem.jsonld.api.JsonLdError {
