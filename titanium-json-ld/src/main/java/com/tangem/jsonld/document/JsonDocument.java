...
public final class JsonDocument implements Document {
     ...
     */
    public static final JsonDocument of(final InputStream is)  throws com.tangem.jsonld.api.JsonLdError {
     ...
     */
    public static final JsonDocument of(final MediaType contentType, final InputStream is)  throws com.tangem.jsonld.api.JsonLdError {
     ...
     * @return {@link Document} representing JSON document
     */
    public static final JsonDocument of(final Reader reader)  throws com.tangem.jsonld.api.JsonLdError {
     ...
     * @throws com.tangem.jsonld.api.JsonLdError
     */
    public static final JsonDocument of(final MediaType contentType, final Reader reader)  throws com.tangem.jsonld.api.JsonLdError {
    ...
    private static final JsonDocument doParse(final MediaType contentType, final JsonParser parser) throws com.tangem.jsonld.api.JsonLdError {
        
        if (!parser.hasNext()) {
            throw new com.tangem.jsonld.api.JsonLdError(JsonLdErrorCode.LOADING_DOCUMENT_FAILED, "Nothing to read. Provided document is empty.");
        }
