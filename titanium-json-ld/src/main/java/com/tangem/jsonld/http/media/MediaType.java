...
import com.tangem.jsonld.http.media.MediaTypeParameters;
import com.tangem.jsonld.http.media.MediaTypeParser;
...
public final class MediaType {
    ...
    private final com.tangem.jsonld.http.media.MediaTypeParameters parameters;

    protected MediaType(String type, String subtype, com.tangem.jsonld.http.media.MediaTypeParameters parameters) {
        this.type = type;
    ...
    protected MediaType(String type, String subtype) {
        this(type, subtype, com.tangem.jsonld.http.media.MediaTypeParameters.EMPTY);
    }
    ...
    public static final MediaType of(final String value) {
        ...
        if (JavaOver8Utils.isBlank(value)) {
            return null;
        }
        return new com.tangem.jsonld.http.media.MediaTypeParser(value).parse();
    }
}
