...
import com.tangem.jsonld.loader.SchemeRouter;
...
public final class JsonLdOptions {
    ...
    private com.tangem.jsonld.api.JsonLdEmbed embed;
    ...
    public JsonLdOptions(DocumentLoader loader) {
        ...
        // framing defaults
        this.embed = com.tangem.jsonld.api.JsonLdEmbed.ONCE;
        this.explicit = false;
    ...
    public com.tangem.jsonld.api.JsonLdEmbed getEmbed() {
        return embed;
    }
