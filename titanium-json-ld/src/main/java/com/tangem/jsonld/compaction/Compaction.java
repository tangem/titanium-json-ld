...
public final class Compaction {
    ...
    public JsonValue compact(final JsonValue element) throws com.tangem.jsonld.api.JsonLdError {
        return compact(null, element);
    }
    
    public JsonValue compact(final String activeProperty, final JsonValue element) throws com.tangem.jsonld.api.JsonLdError {
        ...
        for (final String expandedProperty : expandedProperties) {
            ...
            if (Keywords.TYPE.equals(expandedProperty)) {
                ...
                // 12.2.2.
                    ...
                    throw new com.tangem.jsonld.api.JsonLdError(JsonLdErrorCode.INVALID_TYPE_VALUE, "@type value is not valid [" + expandedValue + "].");
                }
