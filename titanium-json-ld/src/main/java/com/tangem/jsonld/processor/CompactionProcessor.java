...
public final class CompactionProcessor {
    ...
    public static final JsonObject compact(final URI input, final URI context, final com.tangem.jsonld.api.JsonLdOptions options) throws com.tangem.jsonld.api.JsonLdError {
    ...
    public static final JsonObject compact(final URI input, final Document context, final com.tangem.jsonld.api.JsonLdOptions options) throws com.tangem.jsonld.api.JsonLdError {
        ...
        if (remoteDocument == null) {
            throw new com.tangem.jsonld.api.JsonLdError(JsonLdErrorCode.LOADING_DOCUMENT_FAILED, "Returned document is null [" + input + "].");
        }
        
        return compact(remoteDocument, context, options);
    }

    public static final JsonObject compact(final Document input, final Document context, final com.tangem.jsonld.api.JsonLdOptions options) throws JsonLdError {
