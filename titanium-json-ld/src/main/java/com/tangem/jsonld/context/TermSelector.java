...
import com.tangem.jsonld.context.InverseContext;
...
public final class TermSelector {
    ...
    private TermSelector(final com.tangem.jsonld.context.ActiveContext activeContext, final String variable, final Collection<String> containers, final String typeLanguage) {
