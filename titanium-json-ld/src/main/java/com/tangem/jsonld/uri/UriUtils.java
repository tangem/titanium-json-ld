...
public final class UriUtils {
    ...
    public static final boolean isURI(final String value) {
        ...
        return value != null 
                    && !JavaOver8Utils.isBlank(value)
                    && !com.tangem.jsonld.lang.Keywords.matchForm(JavaOver8Utils.strip(value))
                    && create(JavaOver8Utils.strip(value)) != null;
    }
    ...
    public static final URI create(final String uri) {
        ...
        String uriValue = JavaOver8Utils.strip(uri);
    ...
    public static final boolean isNotURI(final String uri) {
        return uri == null 
                || (!JavaOver8Utils.isBlank(uri)
                        && (Keywords.matchForm(JavaOver8Utils.strip(uri))
                        || create(JavaOver8Utils.strip(uri)) == null));
    }
    ...
    protected static final boolean isDefined(final String value) {
        return value != null && !JavaOver8Utils.isBlank(value);
    }
