 ...
 */
package com.tangem.jsonld.json;
...
public final class JsonLdComparison {
    ...
    private static final boolean equals(final JsonValue value1, final JsonValue value2, final String parentProperty) {
        ...
        if (com.tangem.jsonld.json.JsonUtils.isNull(value1) && com.tangem.jsonld.json.JsonUtils.isNull(value2)) {
            return true;
        }
        
        if (com.tangem.jsonld.json.JsonUtils.isScalar(value1) && com.tangem.jsonld.json.JsonUtils.isScalar(value2)) {
            return Objects.equals(value1, value2);
        }
        
        if (com.tangem.jsonld.json.JsonUtils.isArray(value1) && com.tangem.jsonld.json.JsonUtils.isArray(value2)) {
            return arrayEquals(value1.asJsonArray(), value2.asJsonArray(), parentProperty);
        }
        
        if (com.tangem.jsonld.json.JsonUtils.isObject(value1) && JsonUtils.isObject(value2)) {
