...
public final class JsonCanonicalizer {
    ...
    private static final void canonicalize(final JsonValue value, final Writer writer) throws IOException {
        ...
        if (com.tangem.jsonld.json.JsonUtils.isNull(value)) {
            writer.write("null");
            
        } else if (com.tangem.jsonld.json.JsonUtils.isScalar(value)) {
                        
            if (com.tangem.jsonld.json.JsonUtils.isNumber(value)) {
        ...
        } else if (com.tangem.jsonld.json.JsonUtils.isArray(value)) {
